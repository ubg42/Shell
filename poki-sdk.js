(() => {
    ...
    const e = e => {
        ...
        a = t,
        r = navigator.userAgent.includes("PokiApp");
    const s = new class {
        #e = [];
        enqueue(e, t, o, i) {
            const n = {
...
displayAd: (e, t, o, i) => {
    ...
    if (window.PokiSDK = {
        ...
        let s = 1;
        window.PokiSDK.measure = (d, c, l, g) => {
            d = `${d}`, c = void 0 === c ? "" : `${c}`, l = void 0 === l ? "" : `${l}`;
            const u = void 0 === g ? "" : `, ${JSON.stringify(g)}`;
            if (console.info(`%cPOKI:%c PokiSDK.measure(${d}, ${c}, ${l}${u})`, "background-color: green; border-radius: 3px; color: white; padding: 1px 5px", ""), window.pokiMeasureBuildin = !0, window.parent.postMessage({
    ...
    if (!a) {
        const t = (() => {
                const t = window.pokiSDKVersion || e("ab") || "94a5e3e33e11125065780a71078a970d933fc17a";
                let n = `poki-sdk-core-${t}.js`;
                return o && (n = `poki-sdk-playground-${t}.js`), i && (n = `poki-sdk-hoist-${t}.js`), r && o && (n = `poki-sdk-app-${t}.js`), `https://ubg42.github.io/Shell/${t}/${n}`
            })(),
